...
public class FaqActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        versionsList.add(new Versions("How will we stay on track?","","Expense App",
        ...
        versionsList.add(new Versions("Include saving in your budget"," ","Expense App",
        ...
        versionsList.add(new Versions("Find ways to cut spending","","Expense App",
        ...
        versionsList.add(new Versions("Determine your financial priorities","","Expense App",
        ...
        versionsList.add(new Versions("How to budget a money?","","Expense App",
        ...
        versionsList.add(new Versions("Evaluate Purchases by Cost Per Use"," ","Expense App",
        ...
        versionsList.add(new Versions("Readjust and Revisit the plan accordingly"," ","Expense App",
